...
public class HCSController {
	...
	public String addAppointment(@RequestParam("testId") BigInteger testId,
			@DateTimeFormat(pattern = "dd-MM-yyyy hh:mm:ss") @RequestParam("dateAndTime") LocalDateTime dateTime,
