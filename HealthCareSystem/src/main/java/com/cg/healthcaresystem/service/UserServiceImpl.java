...
public class UserServiceImpl implements UserService {
	...
	public static void validateCenterId(String centerId, List<DiagnosticCenter> centerList) throws UserDefinedException {
		int i=0;
	...
	public static void validateTestid(String removeTestId, String centerId, List<DiagnosticCenter> centerList) throws UserDefinedException
	{
		int i=0;
		int j=0;
		for(i=0;i<centerList.size();i++)
	...
	public static void validateCenterIndex(String selectCenterIndex, List<DiagnosticCenter> centerList1) throws UserDefinedException
	{
		String regex="^[0-9]*$";
		Pattern pattern = Pattern.compile(regex);
		...
		if(!matcher.matches())
		{
			...
			if(Integer.parseInt(selectCenterIndex) >= centerList1.size() || (Integer.parseInt(selectCenterIndex) < 0))
			{
	...
	public static void validateTestIndex(String selectTestIndex, int selectCenterIndex, List<Test> testList) throws UserDefinedException
	{
		String regex="^[0-9]*$";
		Pattern pattern = Pattern.compile(regex);
	...
	public static void validateUserId(String userId, List<User> userList) throws UserDefinedException
	{
		...
		if(i==userList.size())
		{
			throw new UserDefinedException("Invalid User ID. Make sure you are entering the exact id given after registration!");
		}
	}
	
	public static void validateAppointmentId(String appointmentid, List<Appointment> listofappointment) throws UserDefinedException
	{
		int i=0;
