...
//			  		}
			  	...
			  	case 5: //ApproveAppointment
			  	  ...
			  	  {
			  	   DiagnosticCenter obj = iterator.next();
			  	   System.out.println(count+". CenterId: "+obj.getCenterId()+" CenterName: "+obj.getCenterName());
			  	   count++;
			  	  }		  	 
			  	  ...
			  	  try {
			  		  ...
			  		  for(int i=0;i<centerList.size();i++)
			  		  {
			  			  ...
			  			  {
			  				  List<Appointment> listOfAppointments=centerList.get(i).getListOfAppointments();
			  				  ...
			  				  else
			  				  {
			  					  ...
			  					  {
			  						  System.out.println("Appointment ID: "+listOfAppointments.get(j).getAppointmentId()+" UserId: "+listOfAppointments.get(j).getUser().getUserId()+" TestDetails: "+listOfAppointments.get(j).getTest().getTestName()+" Status: "+listOfAppointments.get(j).isApproved());
			  					  }
			  					  ...
			  					  for(int k=0;k<listOfAppointments.size();k++)
			  					  {
			  						  ...
			  						  if(listOfAppointments.get(k).getAppointmentId().equals(appointmentId))
			  						  {
			  		  ...
			  		  } System.out.println("Diagnostic center with "+centerId+" not found");	
...
//		  		}
		  		...
		  		Appointment ap = new Appointment(user,  testList.get(selectTestIndexNum), centerList.get(selectCenterIndexNum), date);
...
//		  		}
  			 ...
  			 case 3:
  				 ...
  				 if(centerList.size()<1) System.out.println("We are not functional yet!");
  				 else {
  					 ...
  					 for(int centerIndex=0;centerIndex<centerList.size();centerIndex++)
  					 {
  						 for(int appointmentListIndex=0;appointmentListIndex<centerList.get(centerIndex).getListOfAppointments().size();appointmentListIndex++)
  						 {
  							 if(centerList.get(centerIndex).getListOfAppointments().get(appointmentListIndex).getUser().getUserId().equals(userId))
  							 {
  								 System.out.println("AppointmentID: "+centerList.get(centerIndex).getListOfAppointments().get(appointmentListIndex).getAppointmentId()
  										 + " TestName: "+centerList.get(centerIndex).getListOfAppointments().get(appointmentListIndex).getTest().getTestId()+" CenterId: "+
  										centerList.get(centerIndex).getListOfAppointments().get(appointmentListIndex).getCenter().getCenterName() );
  								 appointmentCount++;
  							 }
  						 }
  					 }
